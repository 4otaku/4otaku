...
<? 
	foreach ($data['sidebar']['test']['tags'] as $maintag) {
		?>
			<li><a class="shifter" rel="<?=$maintag['alias'];?>" href="/post/mixed/tag=<?=$maintag['alias'];?>"><?=$maintag['name'];?></a>
				<ul>
					<?  $i = 0;
						foreach ($maintag['lesser'] as $key => $tag) { $i++;
							?>
							<li><a class="shifter" rel="<?=$key;?>+<?=$maintag['alias'];?>" href="/post/mixed/tag=<?=$key;?>+<?=$maintag['alias'];?>/"><?=$data['sidebar']['test']['alias'][$key];?></a></li>
							<?
						if ($i>10) break;}
					?>
				</ul>
