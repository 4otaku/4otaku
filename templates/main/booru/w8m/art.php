<div class="mini-shell">
	...
	<a href="/art/download/<?=_base64_encode(hex2bin($data['main']['gallery']['md5']));?>" target="_blank">Скачать их одним архивом.</a> (~<?=ceil($data['main']['gallery']['filesize']/1024/1024);?> мб)
	<? } ?><br />
	Имя файла: <a href="/art/download/<?=_base64_encode(hex2bin($data['main']['art']['md5']));?>" target="_blank"><?=$data['main']['art']['filename'];?></a> 
</div>
<br />
<div class="post">
	<div class="innerwrap">
				...
				<td class="booru_main"> 
					<? if ($data['main']['art']['resized'] && $sets['art']['resized']) { ?>
						...
						<div class="booru_img image booru" rel="resized">
							<a href="/art/download/<?=_base64_encode(hex2bin($data['main']['art']['md5']));?>" target="_blank">
