<div>
	<img src="<?=SITE_DIR?>/images/thumbs/305122.jpg" align="left" />
	<p>
	...
	<p>
		...
		Новую ссылку на замену битой можно предоставить в комментариях, модераторы обязательно заменят ей старую. То же самое и если вы просто добавляете зеркало к ссылке. Обсуждение и комментарии моей работы <a href="<?=SITE_DIR?>/news/gouf_mk1/">по этой ссылке</a>
	</p>
	<p>
