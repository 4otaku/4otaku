...
<br /> 
<a href="<?=SITE_DIR.'/admin'?>/tags/problem/alias/">Проблемные теги - алиас</a>. <a href="<?=SITE_DIR.'/admin'?>/tags/problem/match/">Проблемные теги - совпадения</a>. <a href="<?=SITE_DIR.'/admin'?>/tags/problem/empty/">Проблемные теги - пустые</a>. 
 <br /><br />
 <? if ($url[4] != 'match') { ?>
	<? if ($url[4] != 'empty') { ?>
