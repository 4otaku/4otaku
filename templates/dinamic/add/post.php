<script type="text/javascript" src="<?=SITE_DIR?>/jss/m/?b=jss&f=ajaxupload.js,add/common.js,add/text.js,add/post.js"></script>
			...
			<tr>
				...
				<td class="inputdata">
					<table>
						<tr>
							<td>
								<img src="<?=SITE_DIR.'/images'?>/upload_button.png" id="post-image">
							</td>
							<td>
								<img class="processing-image" src="<?=SITE_DIR.'/images'?>/ajax-processing.gif" />
							</td>
							<td>
							...
							<td class="cancel-holder">
								<span class="processing-image">Отменить <img class="image_upload_stop right" src="<?=SITE_DIR.'/images'?>/cancel.png"></span>
							</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				...
				<td class="inputdata">
					<table>
						<tr>
							<td>
								<img src="<?=SITE_DIR.'/images'?>/upload_button.png" id="post-file" rel="add">
							</td>
							<td>
								<img class="processing-file" src="<?=SITE_DIR.'/images'?>/ajax-processing.gif" />
							</td>
							<td>
								<span class="processing-file">Файл загружается. (Вы можете загружать несколько файлов одновременно.)</span>
							</td>
							<td class="cancel-holder">
								<span class="processing-file">Отменить <img class="file_upload_stop right" src="<?=SITE_DIR.'/images'?>/cancel.png"></span>
							</td>
						</tr>
					</table>
				</td>
