...
?>
<script type="text/javascript" src="<?=$def['site']['dir']?>/jss/m/?b=jss&f=edit_form.js,fileupload.js,add/post.js"></script>
		...
		<td>
			<table>
				<tr>
					...
					<td>
						<img class="processing-file hidden" src="<?=$def['site']['dir']?>/images/ajax-processing.gif" />
					</td>
					<td>
