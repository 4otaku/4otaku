<html>
	<head>
		...
		<script type="text/javascript" src="<?=SITE_DIR?>/jss/m/?b=jss&f=jquery-1.3.2.min.js,slideshow.js"></script>
		<link rel="stylesheet" href="<?=SITE_DIR?>/jss/m/?b=jss&f=slideshow.css" type="text/css" media="screen" />		
	</head>
	<body>
		<table width="<?=($def['booru']['resizewidth']*1.1+100);?>px" class="center">
			...
			<tr>
				<td align="left" width="50px">
					<img src="<?=SITE_DIR?>/images/left_arrow.png" class="arrow_left">
					&nbsp;
				</td>
				...
				<td align="right" width="50px">
					<img src="<?=SITE_DIR?>/images/right_arrow.png" class="arrow_right">
					&nbsp;
				</td>
			</tr>
		</table>
