...
--
-- Дамп данных таблицы `gouf_base`
--

INSERT INTO `gouf_base` (`id`, `alias`, `text`) VALUES
(4, 'mediafire.com', 'Preparing download...|Data is loading from the server..'),
...
(7, '4shared.com', '<font>Скачать</font>|<font>Скачать сейчас</font>');

-- --------------------------------------------------------

--
-- Структура таблицы `gouf_links`
--
...
--
-- Дамп данных таблицы `gouf_links`
--
